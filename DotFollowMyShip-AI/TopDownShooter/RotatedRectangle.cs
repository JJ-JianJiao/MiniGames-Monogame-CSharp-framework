...
{
    //cnobert: this code was lifter from http://www.xnadevelopment.com/tutorials/rotatedrectanglecollisions/rotatedrectanglecollisions.shtml
    class RotatedRectangle
    {
        ...
        public void Draw(SpriteBatch drawingSurface, Texture2D collisionDebugTexture)
        {
            drawingSurface.Draw(collisionDebugTexture, new Vector2(CollisionRectangle.Location.X + CollisionRectangle.Width / 2, CollisionRectangle.Location.Y + CollisionRectangle.Height / 2), 
                                CollisionRectangle, Color.White, Rotation, Origin, 1, SpriteEffects.None, 0);
